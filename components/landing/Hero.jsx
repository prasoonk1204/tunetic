  ...
  return (
    <div className="relative h-screen sm:m-8 flex justify-center items-center p-4 sm:p-8">
      <div className="z-10 text-center">
        <h1 className="text-5xl sm:text-6xl md:text-[80px] mb-4">
        ...
        <Link href="/login">
          <button className="bg-emerald-500 hover:bg-emerald-400 hover:scale-103 px-6 sm:px-12 py-2 sm:py-3 rounded-4xl transition-all duration-200 cursor-pointer text-2xl shadow-[inset_0_-2px_4px_rgba(255,255,255,0.5)] font-medium">
            Join the Vibe
          </button>
        </Link>
      </div>
